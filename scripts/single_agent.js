...
// const num_rectangles = 35;
// const min_size = 30;
// const max_size = 80;
// const x_range = [0, 500];
// const y_range = [0, 500];

// let OBSTACLES = generate_non_overlapping_rectangles(num_rectangles, min_size, max_size, x_range, y_range);

// console.log(OBSTACLES.toString())

// OBSTACLES = [
//     new Rectangle([0, 300], [100, 400]),
//     new Rectangle([220, 300], [480, 450]),
//     new Rectangle([230, 180], [270, 240]),
//     new Rectangle([150, 450], [250, 480]),
//     new Rectangle([100, 430], [150, 480]),
//     new Rectangle([0, 0], [10, 200]),
//     new Rectangle([300, 100], [400, 250]),
//     new Rectangle([200, 250], [280, 280]),
//     new Rectangle([400, 450], [440, 480]),
//     new Rectangle([100, 150], [200, 180])
//                 ];
